(function () {
    ...
    function TimelineController() {
        ...
        vm.statusList = [
            ...
            { status: 'Planowanie podpisania umowy', inputDate: new Date(), descr: 'Prospekt z potencjałem', completed: false },
            { status: 'Umowa podpisana', inputDate: new Date(), descr: 'Prospekt z potencjałem', completed: false }
        ]
    }
